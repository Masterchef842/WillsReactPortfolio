...
function Resume(){
    ...
    return (
        <Row >
            ...
            <Button href="https://docs.google.com/document/d/1lFRkE5YcmBWq92EbrwdYNRiIRqi491jTU2YMrqXZpko/edit?usp=sharing" variant="outline-primary" style={{width:'20%', height:'30%', fontSize:"200%"}} onClick={()=>{downloadFile(PDFurl)}} >Download</Button>
